...
class VentanaIncisoC(QDialog):
    def __init__(self, presentador):
        self.__presentador = presentador
        QDialog.__init__(self)
        uic.loadUi('./View/ui/ventana_IncisoC.ui', self)
        ...
        self.tablaTurnos.setColumnCount(5)
        self.tablaTurnos.setHorizontalHeaderLabels(['Sangre', 'Orina', 'Rayos X', 'Ultrasonido', 'TAC'])

...
class VentanaMedicos(QDialog):
    def __init__(self, presentador):
        ...
        uic.loadUi('./View/ui/vistaMedicos.ui', self)
        ...
        self.tableMedicos.itemClicked.connect(self.__presentador.habilitar_botones_generales)

        self.tableMedicos.setColumnCount(8)
        self.tableMedicos.setHorizontalHeaderLabels(['Carnet de Identidad', 'Nombre y Apellidos', 'Sexo',
                                                     'Especialidad', 'Año Graduado', 'Años de Exp.',
                                                     'Centro al que pertenece', 'Nivel del Centro'])
        self.tableMedicos.resizeColumnsToContents()
